...
export function PrincipalInfo({ business }: Props) {
  ...
  return (
    <>
        ...
        <View className="flex-row items-center mb-4 pt-4">
          ...
          <View className="flex-1">
            <View className="flex-row justify-between items-center">
              ...
              <MiniIconButton icon="pencil-outline" iconSize={16} onPress={() => setModalVisible(true)} />
            </View>
      ...
      <MyModal isVisible={modalVisible} onClose={() => setModalVisible(false)} title="Editar Información del Negocio">
